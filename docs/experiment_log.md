...
| Manual random split diagnostic | Random 80/20 repeated seeds | S2 only, Context only, S2 + Context | Same manual regression models | Diagnostic comparison with easier random-split validation |
